...
export default function RoleAccessPage() {
  ...
  const handleGoToAdmin = () => {
    // Redirect to admin panel (adjust URL as needed)
    window.open('https://ticket-admin-phi.vercel.app/', '_blank')
  }
    ...
    switch (role) {
      case 'admin':
        return {
          ...
          message: 'You have administrator privileges. This client application is for customers only.',
          suggestion: 'Please use the admin panel for administrative tasks.'
        }
      case 'master':
        return {
          title: 'Master Access',
          message: 'You have master privileges. This client application is for customers only.',
          suggestion: 'Please use the admin panel for administrative tasks.'
        }
      case 'scanner':
        return {
          title: 'Scanner Access',
          message: 'You have scanner privileges. This client application is for customers only.',
          suggestion: 'Please use the admin panel for scanner operations.'
        }
      case 'client':
      case 'buyer':
        return {
          title: 'Client Access',
          message: 'You have client privileges and should have access to this application.',
        ...
        <Card className="border-destructive/20">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              {(userRole === 'admin' || userRole === 'master' || userRole === 'scanner') && (
                <Button
